          ...
          <div class="row mx-0 border-bottom border-dark mb-3">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="mb-3">
                ...
                <input class="form-control" placeholder="" value="0" id="AnnualIncome" data-rule-number="" dmx-style="value" .toFixed(2)>
                <div class="form-group mb-3">
                  <label for="input1" class="form-label">Medicare Matching:</label>
                ...
                <div class="form-group mb-3">
                  <label for="input1" class="form-label">Social Security Matching:</label>
                  <input type="text" class="form-control" placeholder="" id="FICAMedBenifit" dmx-bind:value="(AnnualIncome.value.toNumber() &gt; 167770)?10397.4:(AnnualIncome.value.toNumber() * 0.062).toFixed(2))" readonly="true">
                  <small id="input1_help" class="form-text text-muted">Your input is very valuable.</small>
                </div>
                <div class="mb-3">
                  <label for="inp_fname" class="form-label">Your matching FICA/ Medicare benefit:</label>
                  <input type="text" class="form-control" placeholder="" id="FICAMedBenifit" dmx-bind:value="(AnnualIncome.value.toNumber() &gt; 167770)?10397.4:(AnnualIncome.value.toNumber() * (.062 + PayrollTax.value)))" readonly="true">
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
